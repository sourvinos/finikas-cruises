...
namespace CoachRoutes {
    ...
    [Collection("Sequence")]
    public class CoachRoutes06Delete : IClassFixture<AppSettingsFixture> {
        ...
        private readonly string _url = "/coachRoutes/9";
        private readonly string _inUseUrl = "/coachRoutes/1";
        private readonly string _notFoundUrl = "/coachRoutes/999";

        #endregion

        public CoachRoutes06Delete(AppSettingsFixture appsettings) {
