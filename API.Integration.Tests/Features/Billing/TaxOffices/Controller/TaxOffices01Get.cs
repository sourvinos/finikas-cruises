...
namespace TaxOffices {
    ...
    [Collection("Sequence")]
    public class TaxOffices01Get : IClassFixture<AppSettingsFixture> {
        ...
        public TaxOffices01Get(AppSettingsFixture appsettings) {
        ...
        public async Task Admins_Can_List() {
            ...
            var records = JsonSerializer.Deserialize<List<TaxOfficeListVM>>(await actionResponse.Content.ReadAsStringAsync(), new JsonSerializerOptions { PropertyNameCaseInsensitive = true });
