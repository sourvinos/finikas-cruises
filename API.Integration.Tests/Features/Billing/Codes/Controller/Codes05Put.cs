...
namespace Codes {
    ...
    public class Codes05Put : IClassFixture<AppSettingsFixture> {
        ...
        private readonly string _url = "/codes";
        ...
        public async Task Unauthorized_Not_Logged_In(TestCode record) {
            await InvalidCredentials.Action(_httpClient, _baseUrl, _url, _actionVerb, "", "", record);
        }

        [Theory]
        [ClassData(typeof(UpdateValidCode))]
        public async Task Unauthorized_Invalid_Credentials(TestCode record) {
        ...
        [Theory]
        [ClassData(typeof(UpdateValidCode))]
        public async Task Simple_Users_Can_Not_Update(TestCode record) {
        ...
        public async Task Admins_Can_Not_Update_When_Invalid(TestCode record) {
        ...
        [Theory]
        [ClassData(typeof(UpdateValidCode))]
        public async Task Admins_Can_Update_When_Valid(TestCode record) {
