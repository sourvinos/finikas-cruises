...
namespace PaymentMethods {
    ...
    [Collection("Sequence")]
    public class PaymentMethods01Get : IClassFixture<AppSettingsFixture> {
        ...
        public PaymentMethods01Get(AppSettingsFixture appsettings) {
        ...
        public async Task Admins_Can_List() {
            ...
            var records = JsonSerializer.Deserialize<List<PaymentMethodListVM>>(await actionResponse.Content.ReadAsStringAsync(), new JsonSerializerOptions { PropertyNameCaseInsensitive = true });
