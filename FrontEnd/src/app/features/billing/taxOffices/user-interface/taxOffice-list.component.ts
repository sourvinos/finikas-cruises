...
// Custom
import { TaxOfficeListVM } from '../classes/view-models/taxOffice-list-vm'
...
export class TaxOfficeListComponent {

    //#region common #9

    @ViewChild('table') table: Table

    private url = 'taxOffices'
    private virtualElement: any
    public feature = 'taxOfficeList'
    public featureIcon = 'taxOffices'
    public icon = 'home'
    public parentUrl = '/home'
    public records: TaxOfficeListVM[]
