...
// Custom
import { CrewSpecialtyListVM } from '../classes/view-models/crewSpecialty-list-vm'
...
@Component({
    selector: 'crewSpecialty-list',
    templateUrl: './crewSpecialty-list.component.html',
    styleUrls: ['../../../../../assets/styles/custom/lists.css']
})

export class CrewSpecialtyListComponent {

    //#region common #9

    @ViewChild('table') table: Table

    private url = 'crewSpecialties'
    private virtualElement: any
    public feature = 'crewSpecialtyList'
    public featureIcon = 'crewSpecialties'
    public icon = 'home'
    public parentUrl = '/home'
    public records: CrewSpecialtyListVM[]
