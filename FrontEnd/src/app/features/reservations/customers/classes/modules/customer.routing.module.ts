...
const routes: Routes = [
    ...
    { path: 'new', component: CustomerFormComponent, canActivate: [AuthGuardService] },
    { path: ':id', component: CustomerFormComponent, canActivate: [AuthGuardService], resolve: { customerForm: CustomerFormResolver } }
]
