...
@Component({
    selector: 'taxOffice-form',
    templateUrl: './taxOffice-form.component.html',
    styleUrls: ['../../../../../assets/styles/custom/forms.css']
})

export class TaxOfficeFormComponent {

    //#region common #8

    private record: TaxOfficeReadDto
    private recordId: string
    public feature = 'taxOfficeForm'
    public featureIcon = 'taxOffices'
    public form: FormGroup
    public icon = 'arrow_back'
    public input: InputTabStopDirective
    public parentUrl = '/taxOffices'
    ...
    private flattenForm(): TaxOfficeWriteDto {
        return {
    ...
    private getRecord(): Promise<any> {
        if (this.recordId != undefined) {
            return new Promise((resolve) => {
                const formResolved: FormResolved = this.activatedRoute.snapshot.data['taxOfficeForm']
    ...
    private saveRecord(taxOffice: TaxOfficeWriteDto): void {
